...
public final class LinearGradientPaint extends MultipleGradientPaint {
    ...
    public LinearGradientPaint(Point2D start, Point2D end, float[] fractions,
        ...
        //zw, make painter more robust
        if (start.equals(end))
        {  
          this.start = (Point2D)start.clone();
          this.end = new Point2D.Double(start.getX(), start.getY() + 0.0001);
          return;
        }
    ...
    public PaintContext createContext(ColorModel cm,
        ...
        //zw patch for MAC OS X 10.4
        if (hints == null)
        {  
          hints = new RenderingHints(new HashMap<Key, Object>());
