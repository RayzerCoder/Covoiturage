...
public class AfficherUnMessage extends javax.swing.JFrame {

    Covoitureur covoitureurConnecte = Authentification.covoitureurConnecte;
    String mailTo = null;

    public AfficherUnMessage() {
        this.dispose();
    ...
    public AfficherUnMessage(String valueAt, String mailTo) {
        initComponents();
        this.mailTo = mailTo;
    ...
    private void boutton_RetourActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boutton_RetourActionPerformed
        ConsulterMesMessage consulterMesMessage = new ConsulterMesMessage(covoitureurConnecte);
        consulterMesMessage.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AfficherUnMessage().setVisible(true);
            }
        });
    }
